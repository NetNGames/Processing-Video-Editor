...
|Usage | Processing Video Editor
|------|----------
|Load video, audio, or srt subtitle files with Load Files button | * [For video: avi, mp4, mov, and ogg files supported]
...
|Audio clips can be selected using ListBox | * [Clips can be placed on timeline to play when timeline is ran]
* [If no video file loaded, main window will display audio metadata]
|Press play to start timeline. | * [Current time will be displayed on right of timeline and by red bar.]
...
|Video effects can be triggered using ListBox or keyboard commands | * ['I' for Inverted colors]
* ['G' for Greyscale]
* ['O' for Posterize]
* ['P' Pixelate]
...
|Once video and/or audio files are loaded, you may start adding subtitles | * [Add to current timeline time by pressing the Add Subtitle button]
